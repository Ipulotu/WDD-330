// import {getQuakesForLocation} from "./index.js";

//   //const query ='https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2020-01-01&endtime=2020-02-02&latitude=36.114647&longitude=-113.4241471&maxradiuskm=100'
...
// let output = getQuakesForLocation('https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2020-01-01&endtime=2020-02-02&latitude=36.114647&longitude=-113.4241471&maxradiuskm=100');
// console.log(output);